          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <div className="text-green-50 space-y-4">
              <p className="text-base md:text-lg leading-relaxed">
                <strong className="text-orange-300">Laura Gómez</strong>,
                nutricionista especializada en alimentación funcional, creó más
                de{" "}
                <strong className="text-white">
                  200 recetas de desayunos saludables
                </strong>
                , verdaderamente deliciosas y listas en menos de{" "}
                <strong className="text-white">15 minutos</strong>.
              </p>

              <p className="text-base md:text-lg leading-relaxed">
                Cada receta fue diseñada para brindarte todos los nutrientes que
                tu cuerpo necesita desde la primera comida del día, combinando{" "}
                <strong className="text-orange-300">
                  sabor, salud y practicidad
                </strong>{" "}
                en cada preparación.
              </p>
            </div>
